...
import { FaHome, FaPaperPlane, FaTrash, FaCheck } from "react-icons/fa";
import { useState } from 'react';
export default function PedirDiag(){
...
<div className="p-6">
        <h1 className="text-3xl text-center -mt-10 font-bold mb-4"><b>INFORME O DEFEITO APRESENTADO PELO VEÍCULO</b></h1>
