...
export default function Cliente2() {
  ...
  return (
    <div className="bg-indigo-100 shadow-md rounded-lg p-6">
      <p className="text-indigo-950  text-justify text-xl leading-relaxed">
        <span className="font-semibold"><b>Lucilene, 54 anos</b></span>, que trabalha como Supply Chain em uma empresa de alimentos, costuma usar seu carro para se
