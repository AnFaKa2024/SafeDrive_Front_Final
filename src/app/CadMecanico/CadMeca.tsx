...
export default function CadMeca({Nome, DN,  Doc, Login, End, Senha, Anos}: PessoaisProps){
  ...
  return(
    ...
    <>
      <div>
        <h1 className="text-3xl -m-6 text-center font-bold text-indigo-950 mb-6">Seja um de nossos PARCEIROS</h1>
      </div>

      <main className="bg-indigo-100 p-3 m-1 mt-2 rounded-lg shadow-sm space-x-4">
        <h2 className="text-xl text-center text-indigo-950 mb-6"><b>DADOS DO PROPRIETÁRIO DA OFICINA</b></h2>
        ...
        <div className="flex space-x-2 items-center">
          ...
          <input type="date" className="w-36 tetx-center p-2 mb-4 border rounded border-indigo-400 hover:bg-indigo-50" name="data" id={DN? "idDN" : undefined} required /><br />
        </div>
        <br />
        ...
        {/* LOGIN E SENHA */}
        <p className="text-lg text-indigo-950 mb-2"><b>CADASTRO DE LOGIN E SENHA</b></p>
