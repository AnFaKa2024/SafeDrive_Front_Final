...
export default function CadOficina({NomeFantasia, EndOficina}:OficinaProps){
  ...
  return(
    <main className="p-3 mt-2 bg-indigo-100 rounded-lg shadow-md">
      ...
      <h2 className="text-xl font-bold text-indigo-950 mb-6"><b>CADASTRO DA OFICINA</b></h2> 
     
      <label htmlFor="NomeFantasia" className="block text-xl font-medium text-indigo-950 mb-1">Nome da Oficina </label>
      ...
      <div className=" flex flex-wrap gap-4 mb-4">
        {/* Campo Rua */}
        <div className="flex1">
          <label htmlFor="idRua" className="block font-semibold text-xl text-indigo-950  mb-1">Rua</label>
        ...
        {/* Campo Número */}
        <div className="w-20">
          <label htmlFor="idNumero" className="block font-semibold text-xl text-indigo-950  mb-1">Número</label>
        ...
        {/* Campo Bairro */}
        <div className="w-44">
          <label htmlFor="idBairro" className="block font-semibold text-xl text-indigo-950 mb-1">Bairro</label>
        ...
        {/* Campo CEP */}
        <div className="w-44">
          <label htmlFor="idCEP" className="block font-semibold text-xl text-indigo-950 mb-1">CEP</label>
          <input type="text" id="idCEP" placeholder="CEP" className="w-44 p-2 border border-indigo-400 hover:bg-indigo-50 rounded" required />
        </div>

        {/* Campo Cidade */}
        <div className="w-56">
          <label htmlFor="idCidade" className="block font-semibold text-xl text-indigo-950 mb-1">Cidade</label>
